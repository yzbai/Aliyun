...
namespace Aliyun.Acs.Core.Regions
{
    public class InternalEndpointsParser : IEndpointsProvider
    {
        ...
        private XmlDocument LoadEndpointDocument()
        {
            ...
            //string resourceName = /*_namespace + "." +*/ /*Environment.CurrentDirectory + "\\" +*/ BUNDLED_ENDPOINTS_RESOURCE_PATH;

            string resourceName = _assembly.GetManifestResourceNames().Single(str=>str.Contains(BUNDLED_ENDPOINTS_RESOURCE_PATH));
